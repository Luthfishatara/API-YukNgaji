...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2019 at 03:50 AM
...
INSERT INTO `ustad` (`id`, `name`, `umur`, `alamat`, `pendidikan`, `pengalaman`, `jadwal`, `Bintang`, `Santri`, `Pertemuan`) VALUES
(1, 'Ust arroyyan', 17, 'jln arroyyan', 'putus sekolah', 'pernah ngajar di planet namek', 'setiap hari ke delapan', 3, 2000, 20),
(2, 'Ustadz al Ustadzah', 5, 'Jln. buntu Gg. Asgard', 'S3 budidaya cebong albino', 'Belum berpengalaman', 'terserah aja ', 0, 0, 0);
